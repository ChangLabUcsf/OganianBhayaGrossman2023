...
get_mask_V1('name',...
    ...
    './data_spm/c1name_t1.nii',...% gray matter segmentation probability map
    './data_spm/c2name_t1.nii',...% white matter segmentation probability map
    './data_spm/');% where you want to safe the file
